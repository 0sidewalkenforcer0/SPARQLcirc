 ...
 * <pre>
 *   java -jar npcs-rewrite.jar circuit [--construction=factorised|flat]
...
public final class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length != 3) {
            ...
            System.err.println("  java -jar npcs-rewrite.jar circuit [--construction=factorised|flat] "
                    + "<Standard|SPARQL_Star|SPARQL_Star_Row> <dataFile> <queryFile> [sparqlEndpointURL]");
            System.err.println("  java -jar npcs-rewrite.jar rewrite <Standard|SPARQL_Star|SPARQL_Star_Row> <query|path> <text-or-file>");
            System.err.println("  java -jar npcs-rewrite.jar <Standard|SPARQL_Star|SPARQL_Star_Row> <query|path> <text-or-file>  # legacy baseline form");
            System.exit(2);
            return;
        }
